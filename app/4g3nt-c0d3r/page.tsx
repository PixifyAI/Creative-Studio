...
export default function AgentCoderPage() {
  const [browserURL] = useState('https://216.230.232.229:5173/');
  ...
  return (
    <div className="relative flex h-screen bg-[#211059] text-white overflow-hidden">
      {/* Vanta.js Background */}
      ...
      <div className="relative z-10 flex w-full h-full">
        {/* Sidebar */}
        <aside className="w-64 h-full bg-[#161b22] bg-opacity-60 backdrop-blur-md p-4 flex flex-col rounded-tr-lg rounded-br-lg">
        ...
        <main className="flex-1 flex flex-col overflow-hidden">
          ...
          {/* Webview */}
          <div className="flex-1 bg-[#21262d] bg-opacity-60 backdrop-blur-md p-4 overflow-auto">
            <iframe
              ref={browserRef}
              src={browserURL}
