...
import { ChevronRight, Home, Image as ImageIcon, Video, Scissors, FolderOpen, Settings, Sparkles, Zap, Smile, MessageSquare } from "lucide-react"
        ...
        <main className="flex-1 p-8 overflow-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            <Card className="bg-[#21262d] bg-opacity-60 backdrop-blur-md p-6 hover:bg-opacity-80 transition-colors duration-300">
              ...
              <Button variant="ghost" className="w-full justify-between text-[#8A2BE2] hover:text-[#9370DB]">
                Get started
          ...
          <section>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {[
                '/placeholder.svg?text=Neon+City',
                '/placeholder.svg?text=Mystic+Cat',
                '/placeholder.svg?text=Cosmic+Coffee',
                '/placeholder.svg?text=Cyber+Dragon',
                '/placeholder.svg?text=Quantum+Pyramid',
                '/placeholder.svg?text=Stellar+Sailboat',
                '/placeholder.svg?text=Nanotech+Volcano',
                '/placeholder.svg?text=AI+Dreamscape',
              ].map((src, i) => (
                <div key={i} className="aspect-w-1 aspect-h-1 bg-[#21262d] bg-opacity-60 backdrop-blur-md rounded-lg overflow-hidden group">
                  <img src={src} alt={`Gallery image ${i+1}`} className="object-cover transition-transform duration-700 group-hover:scale-110" />
                  {[1, 2, 5].includes(i) && (
