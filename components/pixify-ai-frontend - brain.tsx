...
// Improved Voice Aurora AI Component with AI Brain Synapses Animation
const VoiceAuroraAI = ({ isSpeaking }: { isSpeaking: boolean }) => {
  return (
    <div className="relative w-[100px] h-[100px] flex items-center justify-center mx-auto overflow-hidden">
    ...
    <div className="flex h-screen bg-[#211059] text-white overflow-hidden">
      ...
      <div className="relative z-10 flex w-full">
        ...
        <main className="flex-1 p-8 overflow-auto">
          ...
          <div className="fixed top-24 right-16">
