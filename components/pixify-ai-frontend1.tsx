      ...
      >
        ...
        <nav className="flex-1">
          ...
          <div className="mb-4">
            ...
            <Link href="https://pixify-chat.vercel.app/" className={`flex items-center p-2 hover:bg-[#21262d] hover:bg-opacity-60 hover:backdrop-blur-md rounded-lg mb-1 text-[#8A2BE2] ${router.pathname === '/ai-chat' ? 'bg-[#21262d] bg-opacity-60 backdrop-blur-md' : ''}`}>
              <MessageSquare className="mr-2" size={20} />
              LLM Chat
            </Link>
            <Link href="/ai-images" className={`flex items-center p-2 hover:bg-[#21262d] hover:bg-opacity-60 hover:backdrop-blur-md rounded-lg mb-1 text-[#8A2BE2] ${router.pathname === '/ai-images' ? 'bg-[#21262d] bg-opacity-60 backdrop-blur-md' : ''}`}>
              <ImageIcon className="mr-2" size={20} />
              AI Images
            </Link>
            <Link href="/ai-videos" className={`flex items-center p-2 hover:bg-[#21262d] hover:bg-opacity-60 hover:backdrop-blur-md rounded-lg mb-1 text-[#8A2BE2] ${router.pathname === '/ai-videos' ? 'bg-[#21262d] bg-opacity-60 backdrop-blur-md' : ''}`}>
          ...
          <div className="mb-4">
            ...
            <Link href="/shorteezy" className={`flex items-center p-2 hover:bg-[#21262d] hover:bg-opacity-60 hover:backdrop-blur-md rounded-lg mb-1 text-[#8A2BE2] ${router.pathname === '/shorteezy' ? 'bg-[#21262d] bg-opacity-60 backdrop-blur-md' : ''}`}>
              <Zap className="mr-2" size={20} />
              Shorteezy
            </Link>
            <Link href="/meme-extreme" className={`flex items-center p-2 hover:bg-[#21262d] hover:bg-opacity-60 hover:backdrop-blur-md rounded-lg mb-1 text-[#8A2BE2] ${router.pathname === '/meme-extreme' ? 'bg-[#21262d] bg-opacity-60 backdrop-blur-md' : ''}`}>
              <Smile className="mr-2" size={20} />
              MemeExtreme
            </Link>
            <Link href="https://216.230.232.229:7860/" className={`flex items-center p-2 hover:bg-[#21262d] hover:bg-opacity-60 hover:backdrop-blur-md rounded-lg text-[#8A2BE2] ${router.pathname === '/pixify-webui' ? 'bg-[#21262d] bg-opacity-60 backdrop-blur-md' : ''}`}>
              <Scissors className="mr-2" size={20} />
              Pixify Webui
            </Link>
            <Link href="/4g3nt-c0d3r" className={`flex items-center p-2 hover:bg-[#21262d] hover:bg-opacity-60 hover:backdrop-blur-md rounded-lg text-[#8A2BE2] ${router.pathname === '/4g3nt-c0d3r' ? 'bg-[#21262d] bg-opacity-60 backdrop-blur-md' : ''}`}>
          ...
          <Link href="https://pixify-app-bs-projects-5791d096.vercel.app/" className={`flex items-center p-2 hover:bg-[#21262d] hover:bg-opacity-60 hover:backdrop-blur-md rounded-lg mb-1 text-[#8A2BE2] ${router.pathname === '/ai-social' ? 'bg-[#21262d] bg-opacity-60 backdrop-blur-md' : ''}`}>
            <MessageSquare className="mr-2" size={20} />
            AI Social
          </Link>
        </nav>
...
<Card className="bg-[#21262d] bg-opacity-60 backdrop-blur-md p-6 hover:bg-opacity-80 transition-colors duration-300 rounded-lg border border-gray-600/30 group">
              <h3 className="text-xl font-semibold mb-2 text-[#8A2BE2]">4g3nt c0d3r</h3>
              <p className="text-gray-400 mb-4">Instantly craft full-stack running apps</p>
              <Link href="/4g3nt-c0d3r">
                <Button variant="ghost" className="w-full justify-between text-[#8A2BE2] hover:text-[#9370DB] rounded-md group-hover:bg-gray-800">
                  Generate Code
                  <ChevronRight size={20} />
                </Button>
